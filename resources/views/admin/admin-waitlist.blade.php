                            ...
                            <div class="row">
                                <div class="col-lg-6 col-7">
                                    ...
                                    <p class="text-sm mb-0">
                                        ...
                                        <span class="font-weight-bold ms-1"> count waitlist</span> so far
                                        {{ $usersCount }}
                                    </p>
                                </div>
                                            ...
                                            @foreach ($users as $user)
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center text-sm">
                                                        <span class="text-xs font-weight-bold"> {{ $user->email }}
                                                        </span>
                                                    </td>
                                                    <td class="align-middle text-center text-sm">
                                                        <span class="text-xs font-weight-bold"> {{ $user->referer }}
                                                        </span>
                                                    </td>
                                                        ...
                                                        <div class="progress-wrapper w-75 mx-auto">
                                                            <div class="progress-info">
                                                                <div class="progress-percentage">
                                                                    <span
                                                                        class="text-xs font-weight-bold">{{ $user->created_at->format('F j, Y, g:i A') }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="align-middle">
                                                        <form action="{{ route('waitlist.destroy') }}" method="POST"
