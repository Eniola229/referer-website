            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight" style="color: darkgreen;">Admin Login</h3>
                  <p class="mb-0">If you find your self here in any way and not a staff of AfricICL kindly return back. Thanks.</p>
                </div>
                <div class="card-body">
                  <form role="form" action="{{ route('admin-login.post') }}" method="POST">
                    ...
                    <div class="text-center">
                      <button type="submit" style="background-color: darkgreen; color: white;" class="btn  w-100 mt-4 mb-0">Sign in</button>
                    </div>
                  </form>
                </div>
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-sm mx-auto">
                   ...
                   <a href="{{ route('register') }}" style="color: darkgreen;" class=" font-weight-bold">Sign up</a>
                  </p>
                </div>
              </div>
            </div>
