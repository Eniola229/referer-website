              ...
              <div class="row">
                <div class="col-lg-6 col-7">
                  ...
                  <p class="text-sm mb-0">
                    ...
                    <span class="font-weight-bold ms-1"> count Payment Requests</span> so far {{ $requestsCount }}
                  </p>
                </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        ...
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">{{ $request->user->email }}</h6>
                          </div>
                        </div>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="text-xs font-weight-bold"> {{ $request->amount }} </span>
                      </td>
                       <td class="align-middle text-center text-sm">
                        <span class="text-xs font-weight-bold"> {{ $request->status }} </span>
                      </td>
                      <td class="align-middle">
                        <div class="progress-wrapper w-75 mx-auto">
                          <div class="progress-info">
                            <div class="progress-percentage">
                              <span class="text-xs font-weight-bold">{{ $request->created_at->format('F j, Y, g:i A') }}</span>
                            </div>
                          </div>
                        </div>
                      </td>
                         ...
                         <form id="account-form" action="{{ route('admin-make-payment') }}" method="POST" enctype="multipart/form-data">
                          @csrf
                            <!-- Existing Form Fields -->
                            <label for="account_name">Account Name</label>
                            <input type="text" class="form-control" id="account_name" name="account_name" placeholder="Enter account name" value="{{ $request->withdraw->account_name }}" readonly>

                            <label for="account_number">Account Number</label>
                            <input type="text" id="account_number" class="form-control" name="account_number" placeholder="Enter account number" value="{{ $request->withdraw->account_number }}" readonly>

                            <label for="bank_name">Bank Name</label>
                            <input type="text" id="bank_name" name="bank_name" class="form-control" placeholder="Enter bank name" value="{{ $request->withdraw->bank_name }}" readonly>

                            <input type="hidden" class="form-control" id="user_id" name="user_id" placeholder="Enter user ID" value="{{ $request->user_id }}" readonly>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">Oops! Request Payment is Empty</h6>
                          </div>
                        </div>
                      </td>
                    </tr>
