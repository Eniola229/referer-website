          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Promoters</p>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Waitlist Users</p>
                    <h5 class="font-weight-bolder mb-0">
                       {{ $waitlistCount }}
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Amount to be paid</p>
                    <h5 class="font-weight-bolder mb-0">
                      N {{ $totalBalance }}
                      <!-- <span class="text-success text-sm font-weight-bolder">| Bonus 0</span> -->
                    </h5>
              ...
              <div class="row">
                <div class="col-lg-6 col-7">
                  ...
                  <p class="text-sm mb-0">
                    ...
                    <span class="font-weight-bold ms-1"> count promoters</span> so far {{ $usersCount }}
                  </p>
                </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">Oops! you have no promoter</h6>
                          </div>
                        </div>
                      </td>
                    </tr>
