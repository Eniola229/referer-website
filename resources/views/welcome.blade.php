                ...
                <div class="header-nav-logo">
                    <a href="{{ url('/') }}">
                        <img style="height: 70px;"
                            src="https://pbs.twimg.com/profile_images/1763219067400249344/p7yVhJ4j_400x400.jpg"
                            alt="AfricTv logo">
                    </a>
                </div>
                <ul class="header-nav-lists">
                    <li class="header-nav-list">
                        <a class="header-nav-link header-active" style="color: green;"
                            href="{{ url('/') }}">Home</a>
                    </li>
                    <li class="header-nav-list"><a style="background: darkgreen" class="header-btn header-btn-custom"
                            href="{{ url('promoters') }}">Continue as Promoter</a></li>
                </ul>
    ...
    <div class="jumbotron-container">
        <div class="jumbotron-left">
            <h2 class="jumbotron-header">Hurray!!🎉🎉🎉
                AfricTv is launching soon! Join our waitlist now and be the first to access a vast library of Global
                content, from movies to music, TrendingNews, Education information, and more! </h2>
            <a href="{{ url('promoters') }}" class="btn btn-fill btn-large" style="background: darkgreen;">Continue as
                Promoter</a>
        </div>
