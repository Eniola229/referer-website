...
<head>
    ...
    <title>
        Reset Password - AfricTv Wait list
    </title>
    <!--     Fonts and icons     -->
    <!-- Google Fonts -->
                        ...
                        <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                            <div class="card card-plain mt-8">
                                <div class="card-header pb-0 text-left bg-transparent">
                                    <h3 class="font-weight" style="color: darkgreen;">Reset Password</h3>
                                    <p class="mb-0">Enter your email and new password to reset password</p>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ route('password.store') }}">
                                        ...
                                        <div class="text-center">
                                            <button type="submit" style="background-color: darkgreen; color: white;"
                                                class="btn  w-100 mt-4 mb-0">Reset Password</button>
                                        </div>
                                    </form>
                                </div>
