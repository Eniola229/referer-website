                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Referers</p>
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        ...
                                        <h5 class="font-weight-bolder mb-0">
                                            N {{ $balance }}
                                            <span class="text-success text-sm font-weight-bolder">| Bonus 0</span>
                                        </h5>
                                    </div>
                                </div>
                                <div class="col-4 text-end">
                ...
                <div class="col-md-8 col-12 my-auto text-end">
                    <div class="banner float-lg-end pe-lg-4 pe-2">
                        ...
                        <div class="social-icons d-flex justify-content-end">
                            <a href="https://web.facebook.com/people/AfricTv/61561466822916/" target="_blank"
                                class="mx-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
                                    <div class="bg-gradient-primary border-radius-lg h-100">
                                        <img src="images/refer-your-friend.png"
                        ...
                        <div class="card-header pb-0">
                            <div class="row">
                                <div class="col-lg-6 col-7">
                                    <h6>Total Referers</h6>
                                    <p class="text-sm mb-0">
                                        <i class="fa fa-check text-info" aria-hidden="true"></i>
                                        <span class="font-weight-bold ms-1"> count referer</span> so far
                                        {{ $referersCount }}
                                    </p>
                                </div>
                                                    ...
                                                    <td>
                                                        <div class="d-flex px-2 py-1">
                                                            ...
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <h6 class="mb-0 text-sm">{{ $referer->name }}</h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="align-middle text-center text-sm">
                                                        <span class="text-xs font-weight-bold"> {{ $referer->email }}
                                                        </span>
                                                    </td>
                                                        ...
                                                        <div class="progress-wrapper w-75 mx-auto">
                                                            <div class="progress-info">
                                                                <div class="progress-percentage">
                                                                    <span
                                                                        class="text-xs font-weight-bold">{{ $referer->created_at->format('F j, Y, g:i A') }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
                                        ...
                                        @else
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <h6 class="mb-0 text-sm">Oops! you have no referer</h6>
                                                            <h6 class="mb-0 text-sm">Refer someone to start earning
                                                            </h6>
                                                        </div>
                                                    </div>
                                                </td>
